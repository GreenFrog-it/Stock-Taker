Public Class Accounts
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        Dim conString As String = My.Settings.AccountsConnectionString
        Dim con As New SqlClient.SqlConnection(conString)

        con.Open()
        'Test Opened
        MessageBox.Show("Connection Opened to Database")

        data_adapter = New SqlClient.SqlDataAdapter("SELECT * From tbl_Accounts", con)
